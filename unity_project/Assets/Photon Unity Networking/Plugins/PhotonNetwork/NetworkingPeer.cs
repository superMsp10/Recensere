...
internal class NetworkingPeer : LoadBalancingPeer, IPhotonPeerListener
{
    ...
    protected internal Dictionary<int, PhotonView> photonViewList = new Dictionary<int, PhotonView>(); // : make private again
    ...
    public void OnStatusChanged(StatusCode statusCode)
    {
        ...
        switch (statusCode)
        {
            ...
            case StatusCode.EncryptionFailedToEstablish:
                ...
                this.OpAuthenticate(this.AppId, this.AppVersion, authV, this.CloudRegion.ToString(), this.requestLobbyStatistics);     //  : check if there are alternatives
                break;
