...
public class PhotonView : Photon.MonoBehaviour
{
    ...
    public int viewID
    {
        ...
        set
        {
            ...
            //  : decide if a viewID can be changed once it wasn't 0. most likely that is not a good idea
	...
	///  : Maybe we can have the networkPeer always aware of the previous MasterClient?
	/// </summary>
